...
from keras.layers import Dense, Embedding, add, Add, SpatialDropout1D, LSTM, Input, Bidirectional, Flatten,CuDNNLSTM, Lambda, Dropout, BatchNormalization, Maximum, concatenate,Reshape, Concatenate
