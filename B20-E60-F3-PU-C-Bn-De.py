...
#
#            B     0.9563    0.9513    0.9538     56882
#            M     0.7473    0.8285    0.7858     11479
#            E     0.9510    0.9525    0.9518     56882
#            S     0.9434    0.9227    0.9329     47490
#
#     accuracy                         0.9357    172733
#    macro avg     0.8995    0.9138    0.9061    172733
# weighted avg     0.9371    0.9357    0.9362    172733
#0.936
...
if MODE==2:
    ...
    blstm = CuDNNLSTM(Hidden,batch_input_shape=(maxlen,nFeatures), return_sequences=True)(dropout)
    ...
    with codecs.open('model/pku_train_crffeatures.pkl', 'rb') as fx:
        with codecs.open('model/pku_train_crfstates.pkl', 'rb') as fy:
            with codecs.open('model/pku_train_lstmmodel.pkl', 'wb') as fm:
                ...
                # )
                # print(m)
                model.save("keras/B20-E60-F3-PU-C-Bn-De.h5")
                print('FIN')

if MODE == 3:
    STATES = list("BMES")
    with codecs.open('plain/pku_test.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('baseline/pku_test_B20-E60-F3-PU-C-Bn-De_states.txt', 'w', encoding='utf8') as fl:
            model = load_model("keras/B20-E60-F3-PU-C-Bn-De.h5")
            model.summary()
