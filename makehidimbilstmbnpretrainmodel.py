...
#
#            B     0.9625    0.9605    0.9615     56882
#            M     0.8218    0.8256    0.8237     11479
#            E     0.9584    0.9592    0.9588     56882
#            S     0.9374    0.9378    0.9376     47490
#
#    micro avg     0.9449    0.9449    0.9449    172733
#    macro avg     0.9200    0.9208    0.9204    172733
# weighted avg     0.9449    0.9449    0.9449    172733
...
if MODE == 3:
    ...
    with codecs.open('plain/pku_test.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('baseline/pku_test_pretrained_hidim_bilstm_bn_states.txt', 'w', encoding='utf8') as fl:
