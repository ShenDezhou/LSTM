...
from keras.layers import Dense, Embedding, LSTM, SpatialDropout1D, Input, Bidirectional,BatchNormalization
...
#
#            B     0.9200    0.9372    0.9285     56882
#            M     0.6898    0.7854    0.7345     11479
#            E     0.9261    0.9304    0.9283     56882
#            S     0.9448    0.8868    0.9149     47490
#
#    micro avg     0.9110    0.9110    0.9110    172733
#    macro avg     0.8702    0.8850    0.8765    172733
# weighted avg     0.9135    0.9110    0.9118    172733
...
if MODE == 1:
    with codecs.open('plain/pku_training.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('plain/pku_train_states.txt', 'r', encoding='utf8') as fs:
            ...
            model.save("keras/lstm-bn.h5")
            print('FIN')

if MODE == 2:
    STATES = list("BMES")
    with codecs.open('plain/pku_test.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('baseline/pku_test_lstmbn_states.txt', 'w', encoding='utf8') as fl:
            model = load_model("keras/lstm-bn.h5")
            model.summary()
