...
from keras.layers import Dense, Embedding, SpatialDropout1D, LSTM, Input, Bidirectional, Flatten,CuDNNLSTM, Lambda, Dropout, BatchNormalization, Average, concatenate
...
if MODE==2:
    ...
    concat = concatenate([embeddeda, averagea,averageb])
    ...
    # dense = Dense(nState, activation='softmax', kernel_regularizer=regularizers.l2(Regularization))(dropout)
