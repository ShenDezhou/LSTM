...
if MODE == 1:
    with codecs.open('plain/pku_training.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('plain/pku_train_states.txt', 'r', encoding='utf8') as fs:
            ...
            model.save("keras/B64-E30-F1-L-De.h5")
            print('FIN')

if MODE == 2:
    STATES = list("BMES")
    with codecs.open('plain/pku_test.utf8', 'r', encoding='utf8') as ft:
        with codecs.open('baseline/pku_test_B64-E30-F1-L-De_states.txt', 'w', encoding='utf8') as fl:
            model = load_model("keras/B64-E30-F1-L-De.h5")
            model.summary()
